...
class Envs:
    ...
    SGLANG_DSPARK_DRAFT_TOPK_SAMPLING = EnvBool(False)
    SGLANG_DSPARK_PP_RETAIN_DRAFT_LOGITS = EnvBool(True)
    SGLANG_DSPARK_PP_FAST_REJECTION = EnvBool(False)
    SGLANG_DSPARK_SYNC_VERIFY_BUDGET = EnvBool(False)
